...
- **`lectures/kr-session-03.html`**, the worked example: Knowledge Representation, Session 3, 48 slides (its glossary data is `lectures/kr-session-03-glossary.js`, its screenshots `assets/img/s3-*.png`).
